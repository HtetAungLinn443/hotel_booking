...
if (isset($_POST['form-sub']) && $_POST['form-sub'] == '1') {
    ...
    if (!$process_error) {
        ...
        if ($update) {
            $url = $cp_base_url . "bed_list.php?msg=edit";
...
$title = "Hotel Booking:: Edit Room Bed Type Page";
    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Hotel Room Bed Type Update</h3>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <h3>Bed Type Update</h3>
                    <div class="x_content">
                        <br />
                        <form action="<?php echo $cp_base_url; ?>bed_edit.php" method="POST" id="createForm">
...
$(document).ready(function() {
    $(document).ready(function() {
        $("#submit-btn").click(function() {
            ...
            if (view_name_length > 10 && view_name != '') {
