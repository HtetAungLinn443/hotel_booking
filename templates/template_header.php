        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item <?php if ($current_page == 'our_room') {
                                            echo 'active';
                                        } ?>"><a href="<?php echo $base_url ?>rooms.php" class="nav-link">Our Rooms</a>
                    </li>
                    <li class="nav-item <?php if ($current_page == 'about') {
                                            echo 'active';
                                        } ?>"><a href="<?php echo $base_url ?>about.php" class="nav-link">About Us</a>
                    </li>
                    <li class="nav-item <?php if ($current_page == 'contact') {
                                            echo 'active';
