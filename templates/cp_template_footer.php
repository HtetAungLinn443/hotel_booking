...
<!-- NProgress -->
<script src="<?php echo $base_url ?>assets/backend/js/nprogress/nprogress.js"></script>

<!-- bootstrap-progressbar -->
<script src="<?php echo $base_url ?>assets/backend/js/bootstrap-progressbar/bootstrap-progressbar.min.js"></script>

<!-- bootstrap-daterangepicker -->
<script src="<?php echo $base_url ?>assets/backend/js/moment/min/moment.min.js"></script>
...
<!-- Datatables -->
<script src="<?php echo $base_url ?>assets/backend/js/datatable/datatables.net/jquery.dataTables.min.js"></script>
<script src="<?php echo $base_url ?>assets/backend/js/datatable/datatables.net-bs/dataTables.bootstrap.min.js"></script>

<script src="<?php echo $base_url ?>assets/backend/js/datatable/datatables.net-responsive/dataTables.responsive.min.js">
</script>
