...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo $base_url ?>assets/backend/css/bootstrap-progressbar/bootstrap-progressbar-3.3.4.min.css"
            rel="stylesheet">
        <!-- bootstrap-daterangepicker -->
        <link href="<?php echo $base_url ?>assets/backend/css/bootstrap-daterangepicker/daterangepicker.css"
            rel="stylesheet">
        <!-- PNotify -->
        ...
        <!-- DataTable CSS -->
        <link href="<?php echo $base_url ?>assets/backend/css/datatable/datatables.net-bs/dataTables.bootstrap.min.css"
            rel="stylesheet">
        <link
            href="<?php echo $base_url ?>assets/backend/css/datatable/datatables.net-responsive-bs/responsive.bootstrap.min.css"
            rel="stylesheet">
